...
const getLastUpdated = (time: string) => {
    ...
    return `Last updated at ${hours % MAX_COUNT_OF_HOURS ? hours % MAX_COUNT_OF_HOURS : MAX_COUNT_OF_HOURS}.${minutes} ${hours > MAX_COUNT_OF_HOURS ? POST_MERIDIEM : ANTE_MERIDIEM}`
}
